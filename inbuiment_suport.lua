local colors = {
  "#00FF00", -- Verde
  "#00E600", -- Verde claro
  "#00CC00", -- Verde más claro
  "#00B300", -- Verde oscuro
  "#009900", -- Verde más oscuro
  "#006600", -- Verde muy oscuro
  "#003300", -- Verde casi negro
  "#99FF99", -- Verde pastel
  "#66FF66", -- Verde claro pastel
  "#33FF33", -- Verde muy claro
  "#E6FFE6"  -- Verde muy pastel
}
